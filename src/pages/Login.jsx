...
export default function Login() {
  ...
  // verifyOtp succeeds asynchronously via AuthContext's onAuthStateChange listener,
  // not as a direct return value we can act on here — so we watch `user` instead
  // and navigate away from /login as soon as a session appears.
  useEffect(() => {
