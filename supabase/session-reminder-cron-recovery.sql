-- ============================================================
-- Session Reminder Cron Recovery Script
-- ============================================================
-- Run this in the Supabase SQL Editor any time the four
-- session-reminder-* jobs are missing from cron.job (e.g. after
-- a restore, or if the health check alerts you that jobs vanished).
--
...
-- some (not all) of the four jobs still exist.
--
-- After running, verify with:
--   select jobid, jobname, schedule, active from cron.job order by jobname;
-- You should see exactly 4 rows, all active = true.
-- ============================================================
