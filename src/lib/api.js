...
// Function + GitHub Action (see migration_add_market_calendar.sql). Lets
// analytics.js exclude weekends/holidays from Journaling Consistency and find
// the next real trading day for the "Day After" effect. This is a small,
// non-user-scoped table, so a plain select works for any signed-in user.
